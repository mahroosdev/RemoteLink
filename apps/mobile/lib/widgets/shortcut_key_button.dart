...
class ShortcutKeyButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color background = isHeld
        ? c.blue
        : (isDanger ? c.red.withValues(alpha: 0.1) : c.elevatedCard);
    final Color borderColor =
        isHeld ? c.blue : (isDanger ? c.red.withValues(alpha: 0.5) : c.border);
    final Color textColor =
        isHeld ? Colors.white : (isDanger ? c.red : c.textSecondary);
